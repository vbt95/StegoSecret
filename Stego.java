...
public class Stego extends JFrame implements ActionListener
{
    ...
    */
    ...
    // declaration of buttons and panels used
    ...
    /**
     * To initialize various components of main window
     */
    ...
    /**
     * Action listener for various actions performed on buttons
     */
    public void actionPerformed(ActionEvent ae)
    {
        // hide button clicked so bring it up front
        ...
        // unhide button clicked so bring it up front
        ...
        // help button clicked so bring it's window up front
        else if(ae.getSource()==helpButton)
        {
            help();
        }
        // about button clicked so bring it's window up front
